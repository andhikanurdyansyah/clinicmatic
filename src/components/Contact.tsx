        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Kirim via WhatsApp
              </button>
            </form>
          ...
          <div className="space-y-6">
            ...
            {/* Social Media */}
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <h3 className="text-2xl font-bold text-secondary mb-6">Media Sosial</h3>
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/ClinicMatic69/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-lg transition-all transform hover:scale-110"
                  aria-label="Facebook"
                >
                ...
                <a
                  href="https://instagram.com/clinicmatic"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-br from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white p-4 rounded-lg transition-all transform hover:scale-110"
            ...
            {/* Google Maps */}
            <div className="rounded-2xl shadow-xl overflow-hidden h-64 sm:h-80 md:h-96 lg:h-[500px] relative">
              <iframe 
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 bg-primary hover:bg-primary/90 text-white px-3 py-2 sm:px-4 sm:py-2 rounded-lg shadow-lg font-semibold text-xs sm:text-sm transition-all transform hover:scale-105 flex items-center gap-2 z-10"
              >
