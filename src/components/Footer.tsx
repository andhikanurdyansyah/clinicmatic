        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              ...
              Komitmen kami adalah memberikan layanan terbaik untuk kendaraan Anda.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold text-primary mb-4">Link Cepat</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-semibold text-primary mb-4">Layanan</h4>
            <ul className="space-y-2 text-gray-300">
              <li>Service Transmisi Matic</li>
              <li>Perbaikan Transmisi</li>
              <li>Diagnosa Kerusakan</li>
              <li>Flush Oli Transmisi</li>
              <li>Perbaikan Elektrik</li>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Clinic Matic. All rights reserved.
            </p>
